...
<head>
    ...
    <title>Register — Yantra Voice Studio</title>
...
<div class="mobile-wrap flex flex-col justify-between px-8 py-12 min-h-screen">
    ...
    <div>
        ...
        <form method="POST" action="{{ url('/register') }}" class="space-y-5">
            @csrf
            <div>
                <label class="block text-xs font-semibold text-[#94A3B8] uppercase tracking-wider mb-2">Full Name</label>
    ...
    <p class="text-center text-sm text-[#94A3B8] mt-8">
        ...
        <a href="{{ url('/') }}" class="text-[#1B2438] font-bold">Sign in</a>
    </p>
</div>
